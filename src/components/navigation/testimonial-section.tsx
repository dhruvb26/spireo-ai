    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className=" space-y-6 text-center">
        ...
        <h2 className="text-3xl font-bold leading-tight text-gray-800 sm:text-4xl lg:text-5xl">
          Join hundreds of LinkedIn creators using{" "}
          <span className="inline text-primary-blue">Spireo</span> to
          ...
          <div className="px-8 py-12">
            <div className="relative mx-auto h-24 w-24">
              <img
                ...
                alt=""
              />
              <div className="absolute right-0 top-0 flex h-7 w-7 items-center justify-center rounded-full bg-darker-blue">
                <svg
